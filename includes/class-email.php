...
class SCB_Email {
    ...
    public function add_resend_metabox() {
        add_meta_box('scb_resend_zoom', 'Course Booking Emails', [$this, 'render_resend_metabox'], 'shop_order', 'side', 'default');
    }
    ...
    public function resend_zoom() {
        ...
        $this->process_email_send(intval($_GET['order']));
    ...
    private function build_html_email($session, $zoom, $attendees, $personalized = false, $meeting_id = '', $password = '', $extra = '') {
        ...
        <div style="font-family:Arial, sans-serif; font-size:15px; line-height:1.6; color:#333;">
            ...
            <?php if (!empty($zoom)): ?>
                <p><strong>Joining Link:</strong><br><a href="<?php echo esc_url($zoom); ?>" target="_blank">Join Meeting</a></p>
            <?php endif; ?>
